...
dataset.convert_measured_to_nominal(which_column="Rh_total_mass", allowed_values=np.array([0.02]))
...
analysis = da.DataAnalysis(dataset=dataset, dataset_all=dataset_all)
